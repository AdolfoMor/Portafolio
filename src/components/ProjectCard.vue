<template>
  <div>
    ...
    <div
      ref="card"
      class="card-container bg-white dark:bg-gray-800 rounded-xl shadow-md transition duration-300 cursor-pointer overflow-hidden mb-8"
    ...
    <teleport to="body">
      ...
      >
        <div
          class="relative bg-white dark:bg-gray-900 rounded-2xl shadow-lg w-full max-w-6xl max-h-[90vh] overflow-y-auto flex flex-col md:flex-row p-4 gap-4 animate-fade-in overscroll-contain touch-auto"
        >
          <!-- Imagen -->
...
// ✅ En caso de desmontar el componente con el modal abierto
onUnmounted(() => {

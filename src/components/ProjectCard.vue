<template>
  <div>
    ...
    >
      <div
        class="relative bg-white dark:bg-gray-900 rounded-2xl shadow-lg w-full max-w-6xl flex p-4 gap-4 animate-fade-in"
      >
        ...
        <div class="w-[40%] flex flex-col justify-center p-6">
